...
export function MonthSelector({ month, onChange, className }: MonthSelectorProps) {
  ...
  return (
    <div className={cn("inline-flex items-center gap-1", className)}>
      ...
      <span className="text-sm font-medium text-gray-800 min-w-[120px] text-center select-none">
      ...
      {!isCurrentMonth(month) && (
        <button
          ...
          className="ml-1 text-[10px] text-sky-600 hover:text-sky-800 font-medium"
        >
          Today
        </button>
      )}
