...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Cash Management (Individual - TOD) XX999", "Invst", "brokerage"),
        ("ACME CORP 401(k) XX1234", "401(k)/403(b)", "401k"),
        ("Student Loan", "\x01", "loan"),
        ("Home Mortgage", "\x01", "mortgage"),
        ("Roth Contributory IRA ...555", "Invst", "roth_ira"),
        ("Jane's HSA Fidelity Go XX6789", "Invst", "hsa"),
        ("State 529 - Child x01", "Invst", "529"),
        ("Contributory ...444", "Invst", "ira"),
    ],
)
